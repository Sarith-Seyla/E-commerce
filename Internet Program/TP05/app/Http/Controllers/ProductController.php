...
use App\Models\Category; // 👈 We'll need this for relationships
...
class ProductController extends Controller
{
    ...
    public function createProduct(Request $request)
    {
        $product = Product::create([
            ...
            'images' => $request->input('images', json_encode([])) // 👈 Default to empty array
        ]);
    ...
    {
        $product = Product::with('category')->find($productId); // 👈 With category info
        if (!$product) {
